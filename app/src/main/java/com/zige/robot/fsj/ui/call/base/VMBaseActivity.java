...
public abstract class VMBaseActivity extends StateActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(App.TAG, "%s onCreate:" + className);
        activity = this;
    ...
    protected void onRestart() {
        super.onRestart();
        Log.i(App.TAG, "%s onRestart:" + className);
    }

    @Override
    protected void onStart() {
        super.onStart();
        Log.i(App.TAG, "%s onStart:" + className);
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.i(App.TAG, "%s onResume:" + className);
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.i(App.TAG, "%s onPause:" + className);
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.i(App.TAG, "%s onStop:" + className);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.i(App.TAG, "%s onDestroy:" + className);
        activity = null;
    }
