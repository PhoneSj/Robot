...
package com.zige.robot.view.crop;
...
public class CropUtil {
    ...
    public static  int calculateBitmapSampleSize(Context c,Uri bitmapUri) throws IOException {
        InputStream is = null;
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
        try {
            is = c.getContentResolver().openInputStream(bitmapUri);
