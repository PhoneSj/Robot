...
public class PickerTimeView extends View {
    ...
    private int mColorText = 0x787D8A;
    private int mColorTextSelect = 0x22B4FF;
    ...
    public void setColorTextSelect(int colorTextSelect){
        this.mColorTextSelect = colorTextSelect;
    }

    public void setMutilTextSize(float min, float max){
        this.mMinTextSize = min;
        this.mMaxTextSize = max;
    }
    ...
    public PickerTimeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void drawData(Canvas canvas) {
        ...
        mPaint.setColor(mColorTextSelect);
