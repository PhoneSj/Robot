...
import com.zige.zige.httplibray.cache.BitmapImageCache;
import com.zige.zige.httplibray.cache.DiskCache;
import com.zige.zige.httplibray.image.NetworkImageView;
import com.zige.zige.httplibray.request.ClearCacheRequest;
import com.zige.zige.httplibray.request.ImageRequest;
import com.zige.zige.httplibray.stack.HurlStack;
import com.zige.zige.httplibray.toolbox.BasicNetwork;
import com.zige.zige.httplibray.toolbox.FileDownloader;
import com.zige.zige.httplibray.toolbox.ImageLoader;
...
public final class AsyncHttp {
    ...
    public Request<?> addRequest(Request<?> request, TimeUnit timeUnit,
                                 int amountTime, boolean isForceUpdate) {
        if (isForceUpdate) {
