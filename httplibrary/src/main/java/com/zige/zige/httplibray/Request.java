...
import com.zige.zige.httplibray.NetroidLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
	...
	/**
	 * Set how long the cache is expired, {@link com.zige.zige.httplibray.cache.DiskCache}
	...
	/**
	 * Prepare to execute, invoke before {@link com.zige.zige.httplibray.stack.HttpStack#performRequest}.
	 ...
	 * However the {@link com.zige.zige.httplibray.request.FileDownloadRequest}
