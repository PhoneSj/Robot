...
import com.zige.zige.httplibray.RequestQueue;
...
public abstract class   ImageLoader {
    ...
    private void onGetImageError(String cacheKey, NetroidError error) {
        // Notify the requesters that something failed via a null com.zige.robot.Result.
    ...
    private class BatchedImageRequest {
        ...
        /** The com.zige.robot.Result of the request being tracked by this item */
